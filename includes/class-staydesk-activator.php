...
class Staydesk_Activator {
    ...
    public static function activate() {
        ...
        $sql_hotels = "CREATE TABLE $table_hotels (
            ...
            chatbot_settings longtext DEFAULT NULL,
        ...
        // Training documents table for chatbot
        $table_training_docs = $wpdb->prefix . 'staydesk_training_documents';
        $sql_training_docs = "CREATE TABLE $table_training_docs (
            id bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
            hotel_id bigint(20) UNSIGNED NOT NULL,
        ...
        // Chat sessions table for booking state
