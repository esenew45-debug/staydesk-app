...
<div class="staydesk-forgot">
        <div class="forgot-container">
            ...
            <form id="request-code-form">
                <?php wp_nonce_field('staydesk_nonce', 'staydesk_nonce_field'); ?>
            ...
            <form id="reset-password-form" class="hidden">
                <?php wp_nonce_field('staydesk_nonce', 'staydesk_nonce_field_reset'); ?>
                <div class="form-group">
            ...
            function initForgotPasswordForm() {
                jQuery(document).ready(function($) {
                    ...
                    $('#reset-password-form').on('submit', function(e) {
                        ...
                        var nonceValue = $('#staydesk_nonce_field_reset').val();
                        $.ajax({
                            url: '<?php echo admin_url('admin-ajax.php'); ?>',
                            type: 'POST',
                            data: {
