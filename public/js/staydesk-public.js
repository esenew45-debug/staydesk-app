...
(function($) {
    ...
    $(document).ready(function() {
        ...
        if (!$('#scroll-progress').length) {
            $('body').prepend('<div id="scroll-progress" role="progressbar" aria-label="Page scroll progress" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0"></div>');
        }
        ...
        function updateScrollProgress() {
            ...
            $('#scroll-progress').css('width', scrolled + '%').attr('aria-valuenow', Math.round(scrolled));
        }
